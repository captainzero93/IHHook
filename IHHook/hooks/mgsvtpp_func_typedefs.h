...
typedef void* (__fastcall BlockMemoryAllocTailFunc)(void* memBlock, uint64_t sizeInBytes, uint64_t alignment, uint32_t categoryTag);
typedef void* (__fastcall BlockMemoryAllocHeapFunc)(uint64_t sizeInBytes, uint64_t alignment, uint32_t categoryTag);
